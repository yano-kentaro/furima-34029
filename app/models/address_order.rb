class AddressOrder
  ...
  def save
    ...
    Address.create(postcode: postcode, city: city, address_line_1: address_line_1, address_line_2: address_line_2, phone_number: phone_number, prefecture_id: prefecture_id, order_id: order.id)
  end
end